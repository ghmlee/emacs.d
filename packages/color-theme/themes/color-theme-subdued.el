...
Based on the Tango color palette."
  ...
  (color-theme-install
   '(color-theme-subdued
     ...
     (font-lock-builtin-face ((t (:foreground "#4e9a06")))) ; dark chameleon
     ;(font-lock-function-name-face ((t (:foreground "#c4a000")))) ; dark butter
     (font-lock-function-name-face ((t (:foreground "#729fcf")))) ; light sky blue
     (font-lock-variable-name-face ((t (nil))))
     (font-lock-preprocessor-face ((t (:foreground "#888a85")))) ; aluminum
     (font-lock-constant-face ((t (:foreground "#4e9a06")))) ; dark chameleon
     (font-lock-type-face ((t (:foreground "#ad7fa8")))) ; light plump
     (font-lock-warning-face ((t (:foreground "#cc0000")))) ; scarlet red
     ...
     (post-header-keyword-face ((t (:foreground "#4e9a06")))) ; dark chameleon
     (post-signature-text-face ((t (:foreground "#cc0000")))) ; dark scarlet red
     (post-quoted-text-face ((t (:foreground "#855c1b")))) ; med-dark chocolate
     (post-double-quoted-text-face ((t (:foreground "#77507b")))) ; plum
     (post-multiply-quoted-text-face ((t (:foreground "#61635e")))) ; dark aluminum
     (post-email-address-text-face ((t (:foreground "#729fcf")))) ; light sky blue
     (post-url-face ((t (:foreground "#729fcf")))) ; light sky blue
     )))
